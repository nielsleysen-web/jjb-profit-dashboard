...
// Media Buyer worktable — creatives and designs with status "Ready to launch"
...
export default function ReadyToLaunch() {
  ...
  const total = readyCreatives.length + readyDesigns.length;
  ...
  return (
    <div style={ui.page}>
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ margin: "4px 0 0 0", fontSize: "12px", color: "#8a92a3" }}>Creatives and designs ready to schedule in Ads Manager</p>
      </div>
