...
async function getAccessToken() {
  ...
  // Vercel bewaart newlines als "\n" — terugzetten naar echte regeleindes
  const key = (process.env.GOOGLE_SA_PRIVATE_KEY || "").replace(/\\n/g, "\n");
  if (!email || !key) throw new Error("Google Drive is niet geconfigureerd (GOOGLE_SA_EMAIL / GOOGLE_SA_PRIVATE_KEY)");
