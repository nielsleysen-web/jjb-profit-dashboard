...
export const SHIPPING = {
  insured: { code: "insured", title: "Spedizione assicurata + ecologica", sub: "Tracciamento del pacco incluso", price: 395 },
  free: { code: "free", title: "Spedizione gratuita", sub: "Tracciamento del pacco incluso", price: 0 },
};

// Membership: 7 dagen proef, daarna €49 elke 28 dagen (Stripe-prijs via env STRIPE_PRICE_MEMBERSHIP)
export const MEMBERSHIP = { trialDays: 7, price: 4900, intervalDays: 28, name: "NeuroTone Membership" };
